"""
Django settings for oach_invoices project.
...
SECRET_KEY = 'django-insecure-se122gv580_$=i5hcw*ed_dyov%8nfma82*952j6s6o@jdt2xz'
...
MIDDLEWARE = [
    ...
    'oach_invoices_api.middleware.CustomHeaderMiddleware',
]
...
ROOT_URLCONF = 'oach_invoices.urls'
...
WSGI_APPLICATION = 'oach_invoices.wsgi.application'
