"""
Django settings for oach_accounts project.
...
SECRET_KEY = 'django-insecure-zsm$o&fp@n=^5mc4))#z%u*d-e_&6paw@6%3v6m2ekn#b-uis#'
...
MIDDLEWARE = [
    ...
    'oach_accounts_api.middleware.CustomHeaderMiddleware',
]
...
ROOT_URLCONF = 'oach_accounts.urls'
...
WSGI_APPLICATION = 'oach_accounts.wsgi.application'
