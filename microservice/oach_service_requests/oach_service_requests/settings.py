"""
Django settings for oach_service_requests project.
...
SECRET_KEY = 'django-insecure-1*u35aryv7g8$k)p#=-ayo^@9-ffcia08^@s^^xonloj-!8!=v'
...
MIDDLEWARE = [
    ...
    'oach_service_requests_api.middleware.CustomHeaderMiddleware',
]
...
ROOT_URLCONF = 'oach_service_requests.urls'
...
WSGI_APPLICATION = 'oach_service_requests.wsgi.application'
