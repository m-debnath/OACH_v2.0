"""
Django settings for oach_activities project.
...
SECRET_KEY = 'django-insecure-mk^kuq*oh6g5snryph18#4cs3-u%$vi=3&asa7)++5j9u!$_f9'
...
MIDDLEWARE = [
    ...
    'oach_activities_api.middleware.CustomHeaderMiddleware',
]
...
ROOT_URLCONF = 'oach_activities.urls'
...
WSGI_APPLICATION = 'oach_activities.wsgi.application'
