...
class Transaction(models.Model):
    ...
    class Meta:
        verbose_name = 'Activities API Transaction'
        verbose_name_plural = 'Activities API Transactions'
        constraints = [
            models.UniqueConstraint(fields=['TransactionName'], name='unique activitiestransactionname')
        ]
...
class TransactionParameter(models.Model):
    ...
    class Meta:
        verbose_name = 'Activities API Parameter'
        verbose_name_plural = 'Activities API Parameters'
        constraints = [
            models.UniqueConstraint(fields=['TransactionName', 'ParameterName'], name='unique activitiestransactionparameter')
        ]
